...
void JpsiMinDCHI2Fitter()
{

  const char varstr[100] = "Jpsi_SMALLESTDELTACHI2";
...
//   dataTree = (TTree*)dataFile.Get("DecayTree");
  ...
  x = new RooRealVar (varstr,"x",0,25);
  ...
  model = new RooAddPdf ("model","model",RooArgList(*sig_pdf,*bkg_pdf),RooArgList(*num0,*num1));
