...
void Plot_MM2_Lifetime ()
{
 ...
 quickplots:
  ...
  nmu_eframe = mcs->plotError(*num_mu,350,390,40);
  ...
  rtau_eframe = mcs->plotError(*Rtau,0.006,0.01,40);
  ...
  nb0_eframe = mcs->plotError(*num_b0,500,560,40);
  ...
  nb_eframe = mcs->plotError(*num_b,420,500,40);
  ...
  ncomb_eframe = mcs->plotError(*num_comb,560,680,40);
