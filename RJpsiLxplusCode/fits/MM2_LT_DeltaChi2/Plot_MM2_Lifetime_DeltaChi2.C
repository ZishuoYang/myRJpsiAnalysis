...
void Plot_MM2_Lifetime_DeltaChi2 ()
{
  ...
  ltframe->SetTitle("ExpLifetime (last fit)");
  ...
  // DCHI^2
  dchi2frame = dchi2->frame(dchi2->getBins());
  dchi2frame->SetTitle("#Delta #chi^{2} (last fit)");
  dchi2frame->SetXTitle("#Delta #chi^{2}");
  gd->plotOn(dchi2frame,Name("dchi2data"));
  model->plotOn(dchi2frame,Name("dchi2fit"));
  model->plotOn(dchi2frame,LineColor(kGreen),Components("mu"));
  model->plotOn(dchi2frame,LineColor(kRed),Components("tau"));
  model->plotOn(dchi2frame,LineColor(kMagenta),Components("b0"));
  model->plotOn(dchi2frame,LineColor(kCyan),Components("b"));
  model->plotOn(dchi2frame,LineColor(kSpring),Components("comb"));
  dchi2pulls_frame = dchi2->frame(dchi2->getBins());
  dchi2pulls_frame->SetTitle("");
  dchi2pulls_frame->SetXTitle("#Delta #chi^{2}");
  dchi2pulls_frame->SetYTitle("pulls");
  RooHist* dchi2pulls = dchi2frame->pullHist("dchi2data","dchi2fit");
  dchi2pulls_frame->addObject((TObject*)dchi2pulls,"XP");
  dchi2pulls_frame->SetMinimum(-5);
  dchi2pulls_frame->SetMaximum(5);

  dchi2_canvas = new TCanvas("dchi2_canvas","dchi2_canvas",800,800);
  dchi2_canvas->cd();
  TPad* dchi2histpad = new TPad("dchi2histpad","dchi2histpad",0.0,0.25,1.0,1.0);
  dchi2histpad->Draw();
  dchi2histpad->SetTopMargin(0.1);
  TPad* dchi2pullpad = new TPad("dchi2pullpad","dchi2pullpad",0.0,0.0,1.0,0.25);
  dchi2pullpad->Draw();
  dchi2pullpad->SetTopMargin(0.1);
  dchi2histpad->cd();
  dchi2frame->SetTitleFont(63,"XY");
  dchi2frame->SetTitleSize(18,"XY");
  dchi2frame->SetTitleOffset(2,"XY");
  dchi2frame->SetLabelFont(63,"XY");
  dchi2frame->SetLabelSize(14,"XY");
  dchi2frame->Draw();
  dchi2histpad->Update();
  dchi2pullpad->cd();
  dchi2pulls_frame->SetTitleFont(63,"XY");
  dchi2pulls_frame->SetTitleSize(18,"XY");
  dchi2pulls_frame->SetTitleOffset(2,"XY");
  dchi2pulls_frame->SetLabelFont(63,"XY");
  dchi2pulls_frame->SetLabelSize(14,"XY");
  dchi2pulls_frame->Draw();
  dchi2pullpad->Update();
  dchi2_canvas->Update();

  // Plot values, errors, and pulls
  nmu_frame = mcs->plotParam(*num_mu,FrameRange(0.98E5,1.02E5),FrameBins(40));
  nmu_eframe = mcs->plotError(*num_mu,390,405,40);
  ...
  // rtau
  rtau_frame = mcs->plotParam(*Rtau,FrameRange(0.005,0.035),FrameBins(40));
  rtau_eframe = mcs->plotError(*Rtau,0.0046,0.0052,40);
  ...
  // B0
  nb0_frame = mcs->plotParam(*num_b0,FrameRange(8.2E3,11.5E3),FrameBins(40));
  nb0_eframe = mcs->plotError(*num_b0,610,640,40);
  ...
  // B
  nb_frame = mcs->plotParam(*num_b,FrameRange(2.375E4,2.625E4),FrameBins(40));
  nb_eframe = mcs->plotError(*num_b,510,530,40);
  ...
  // COMB
  ncomb_frame = mcs->plotParam(*num_comb,FrameRange(3.3E4,3.7E4),FrameBins(40));
  ncomb_eframe = mcs->plotError(*num_comb,310,340,40);
