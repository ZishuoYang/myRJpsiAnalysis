...
RooHistPdf* mu_2d_pdf;
RooHistPdf* tau_2d_pdf;
RooHistPdf* b0_2d_pdf;
RooHistPdf* b_2d_pdf;
RooHistPdf* comb_2d_pdf;
// RooHistPdf* lowmass_2d_pdf;
// RooHistPdf* other_2d_pdf;
RooKeysPdf* mu_dchi2_pdf;
RooKeysPdf* tau_dchi2_pdf;
RooKeysPdf* b0_dchi2_pdf;
RooKeysPdf* b_dchi2_pdf;
RooKeysPdf* comb_dchi2_pdf;
// RooKeysPdf* lowmass_dchi2_pdf;
// RooKeysPdf* other_dchi2_pdf;
RooProdPdf* mu_pdf;
RooProdPdf* tau_pdf;
RooProdPdf* b0_pdf;
RooProdPdf* b_pdf;
...
void FitW_MM2_Lifetime_DeltaChi2 ()
{
  ...
  mu_2d_pdf = new RooHistPdf ("mu_2d_pdf","mu 2d_pdf",RooArgSet(*mm2,*lt),*mu_hist,2);
  tau_2d_pdf = new RooHistPdf ("tau_2d_pdf","tau 2d_pdf",RooArgSet(*mm2,*lt),*tau_hist,2);
  b0_2d_pdf = new RooHistPdf ("b0_2d_pdf","b0 2d_pdf",RooArgSet(*mm2,*lt),*b0_hist,2);
  b_2d_pdf = new RooHistPdf ("b_2d_pdf","b 2d_pdf",RooArgSet(*mm2,*lt),*b_hist,2);
  comb_2d_pdf = new RooHistPdf ("comb_2d_pdf","comb 2d_pdf",RooArgSet(*mm2,*lt),*comb_hist,2);
  
  mu_dchi2_pdf = new RooKeysPdf ("mu_dchi2_pdf","mu dchi2_pdf",*dchi2,*mu_data);
  tau_dchi2_pdf = new RooKeysPdf ("tau_dchi2_pdf","tau dchi2_pdf",*dchi2,*tau_data);
  b0_dchi2_pdf = new RooKeysPdf ("b0_dchi2_pdf","b0 dchi2_pdf",*dchi2,*b0_data);
  b_dchi2_pdf = new RooKeysPdf ("b_dchi2_pdf","b dchi2_pdf",*dchi2,*b_data);
  comb_dchi2_pdf = new RooKeysPdf ("comb_dchi2_pdf","comb dchi2_pdf",*dchi2,*comb_data);
  ...
  mcs = new RooMCStudy(*model,RooArgSet(*mm2,*lt,*dchi2),Binned(true),Extended(true),FitOptions(Save(true),Minos(true),Strategy(2)));
