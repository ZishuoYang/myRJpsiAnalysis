...
# Event Type: 14845008
#
# ASCII decay Descriptor: [B_c+ => (chi_c2(1P) --> (J/psi(1S) => mu+ mu-) ...) mu+ nu_mu]CC
#
...
ToolSvc().EvtGenDecay.UserDecayFile = "./Bc_chic2MuNu,Jpsi=BcVegPy,ffWang,JpsiLeptonInAcceptance.dec"
