...
#
# Syntax is: 
#  gaudirun.py $APPCONFIGOPTS/Gauss/Sim08-Beam3500GeV-mu100-2011-nu2.py
...
Gauss().InteractionPosition = [  0.459*SystemOfUnits.mm ,
...
Gauss().BeamLineAngles     = [ -0.085*SystemOfUnits.mrad,
