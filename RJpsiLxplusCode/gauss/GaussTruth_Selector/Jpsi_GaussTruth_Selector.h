...
#ifndef Jpsi_GaussTruth_Selector_h
#define Jpsi_GaussTruth_Selector_h
...
class Jpsi_GaussTruth_Selector : public TSelector {
public :
  ...
  Double_t BcEst_sp_P;
  Double_t BcEst_sp_PT;
  Double_t Bc_sp_P;
  Double_t Bc_sp_PT;//should be 0
  Double_t Nu_sp_P;
  Double_t Nu_sp_PT;
  Double_t sp_Theta;
...
//   TBranch        *b_psi2S_PCS;   //!
  ...
  Jpsi_GaussTruth_Selector(TTree * /*tree*/ =0) : fChain(0) { }
  virtual ~Jpsi_GaussTruth_Selector() { }
  ...
  ClassDef(Jpsi_GaussTruth_Selector,0);
};

#endif

#ifdef Jpsi_GaussTruth_Selector_cxx
void Jpsi_GaussTruth_Selector::Init(TTree *tree)
{
...
Bool_t Jpsi_GaussTruth_Selector::Notify()
{
...
#endif // #ifdef Jpsi_GaussTruth_Selector_cxx
