...
DaVinci().HistogramFile = "Bc_Psi2SMu_MC_histos.root"
DaVinci().TupleFile = "Bc_Psi2SMu_MC.root"
...
#from MCTuples import MCBc2PsiMuNuTuple
#DaVinci().appendToMainSequence( [ MCBc2PsiMuNuTuple ] )
