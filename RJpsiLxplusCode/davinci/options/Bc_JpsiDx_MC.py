...
# For running over MC B_{u,d,s} -> J/psi X
# OR feed-down modes such as B_c -> psi(2S) mu nu, psi(2S) -> J/psi X
#
...
DaVinci().HistogramFile = "Bc_JpsiDx_MC_histos.root"
DaVinci().TupleFile = "Bc_JpsiDx_MC.root"
...
from MCTuples import MCBc2JpsiCharmTuple
DaVinci().appendToMainSequence( [ MCBc2JpsiCharmTuple ] )
