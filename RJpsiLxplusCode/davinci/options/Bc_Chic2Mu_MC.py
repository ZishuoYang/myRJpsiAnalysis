#########################################################################
# Y -> chi_c2 mu, chi_c2 -> mu mu
# For running over MC Bc -> chi_c2 mu nu
#
...
DaVinci().HistogramFile = "Bc_Chic2Mu_MC_histos.root"
DaVinci().TupleFile = "Bc_Chic2Mu_MC.root"
...
#from MCTuples import MCBc2Chic2MuNuTuple
#DaVinci().appendToMainSequence( [ MCBc2Chic2MuNuTuple ] )
