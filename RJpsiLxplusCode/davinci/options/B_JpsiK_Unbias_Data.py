...
DaVinci().HistogramFile = "B_JpsiK_Unbias_Data_histos.root"
DaVinci().TupleFile = "B_JpsiK_Unbias_Data.root"
...
from BJpsiKUnbiasSelection import MyBJpsiKUnbiasSeq
finalsel = MyBJpsiKUnbiasSeq.sequence()
...
from JpsiKUnbiasRecTuple import getJpsiKUnbiasRecTuple
tuple = getJpsiKUnbiasRecTuple(simulation,MyBJpsiKUnbiasSeq.outputLocation())
