...
def getJpsiRecTuple(simulation,outputLocation):
    ...
    if ospath.exists("weightsSoft.xml"): # for running ganga jobs with modules uploaded as inputFiles
        JpsiRecTuple.Bc.TupleToolApplyIsolationSoft.WeightsFile="weightsSoft.xml"
    else:
        JpsiRecTuple.Bc.TupleToolApplyIsolationSoft.WeightsFile= \
        "/afs/cern.ch/user/z/ziyang/work/RJpsiAnalysis/DaVinciDev_v44r5/Phys/DecayTreeTuple/src/weightsSoft.xml"
    ...
    # For TupleToolTauMuDiscVars
    from Configurables import TupleToolTauMuDiscrVars_RJpsi
    RFVars = JpsiRecTuple.Bc.addTupleTool(TupleToolTauMuDiscrVars_RJpsi, name="TupleToolTauMuDiscrVars_RJpsi")
