...
DaVinci().HistogramFile = "Bc_Data_Psi_histos.root"
DaVinci().TupleFile = "Bc_Data_Psi.root"
...
from PsiRecTuple import getPsiRecTuple
tuple = getPsiRecTuple(simulation,outputLocation)
