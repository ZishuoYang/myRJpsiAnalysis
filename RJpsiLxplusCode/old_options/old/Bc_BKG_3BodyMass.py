...
DaVinci().HistogramFile = "Bc_BKG_3Body_histos.root"
DaVinci().TupleFile = "Bc_BKG_3Body.root"
...
#MyExtraAlg = CombineParticles('MyExtraAlg')
#MyExtraAlg.DecayDescriptor = '[B0 -> B_c+ mu-]cc' # Fake, looking for misPID mass window to veto; loose muon
#MyExtraAlg.DaughtersCuts = {}
#MyExtraAlg.CombinationCut = "(ADAMASS('B0') < 500*MeV) & (ADOCACHI2CUT(30,''))"
#MyExtraAlg.MotherCut = "(ADMASS('B0') < 500*MeV) & (VFASPF(VCHI2) < 25)"
#MyExtraSel = Selection("MyExtraSel", Algorithm = MyExtraAlg, RequiredSelections = [MyBcSel, MuonsSel])
#MyExtraSel.ParticleCombiners = {'':"ParticleAdder"}
