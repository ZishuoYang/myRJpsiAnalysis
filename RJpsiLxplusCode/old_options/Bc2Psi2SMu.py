...
DaVinci().HistogramFile = "Bc2Psi2SMu_histos.root"
DaVinci().TupleFile = "Bc2Psi2SMu.root"
...
MCMuTuple = MCDecayTreeTuple("MCBc2Psi2SMuTuple")
...
tuple = DecayTreeTuple("Bc2Psi2SMu_Tuple")
