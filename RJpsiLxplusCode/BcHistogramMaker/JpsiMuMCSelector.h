...
// Tue Apr  1 17:27:42 2014 by ROOT version 5.34/10
// from TTree MCBc2JpsiMuNuDecayTree/MCBc2JpsiMuNuDecayTree
// found on file: Bc_JpsiMu_MC.root
//////////////////////////////////////////////////////////

#ifndef JpsiMuMCSelector_h
#define JpsiMuMCSelector_h
...
class JpsiMuMCSelector : public TSelector {
public :
  TTree          *fChain;   //!pointer to the analyzed TTree or TChain
  TFile          *OutFile;

  // OPTIONS / DATASET
  TString        fDataset; // of course, this is "JpsiMuNu"
  ...
  JpsiMuMCSelector(TTree * /*tree*/ =0) : fChain(0) { }
  virtual ~JpsiMuMCSelector() { }
  ...
  //ClassDef(JpsiMuMCSelector,0);
};

#endif

#ifdef JpsiMuMCSelector_cxx
void JpsiMuMCSelector::Init(TTree *tree)
{
...
Bool_t JpsiMuMCSelector::Notify()
{
...
#endif // #ifdef JpsiMuMCSelector_cxx
