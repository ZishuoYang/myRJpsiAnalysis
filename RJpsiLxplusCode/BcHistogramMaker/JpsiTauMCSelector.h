...
// Tue Apr  1 17:28:18 2014 by ROOT version 5.34/10
// from TTree MCBc2JpsiTauNuDecayTree/MCBc2JpsiTauNuDecayTree
// found on file: Bc_JpsiTau_MC.root
//////////////////////////////////////////////////////////

#ifndef JpsiTauMCSelector_h
#define JpsiTauMCSelector_h
...
class JpsiTauMCSelector : public TSelector {
public :
  TTree          *fChain;   //!pointer to the analyzed TTree or TChain
  TFile          *OutFile;

  // OPTIONS / DATASET
  TString        fDataset; // of course, this is "JpsiTauNu"
  ...
  JpsiTauMCSelector(TTree * /*tree*/ =0) : fChain(0) { }
  virtual ~JpsiTauMCSelector() { }
  ...
  //ClassDef(JpsiTauMCSelector,0);
};

#endif

#ifdef JpsiTauMCSelector_cxx
void JpsiTauMCSelector::Init(TTree *tree)
{
...
Bool_t JpsiTauMCSelector::Notify()
{
...
#endif // #ifdef JpsiTauMCSelector_cxx
