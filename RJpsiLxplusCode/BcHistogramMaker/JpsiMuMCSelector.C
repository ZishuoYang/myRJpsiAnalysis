#define JpsiMuMCSelector_cxx
// The class definition in JpsiMuMCSelector.h has been generated automatically
...
//
// Root > T->Process("JpsiMuMCSelector.C")
// Root > T->Process("JpsiMuMCSelector.C","some options")
// Root > T->Process("JpsiMuMCSelector.C+")
//
...
void JpsiMuMCSelector::Begin(TTree * /*tree*/)
{
...
Bool_t JpsiMuMCSelector::Process(Long64_t entry)
{
  // The Process() function is called for each entry in the tree (or possibly
  // keyed object in the case of PROOF) to be processed. The entry argument
  // specifies which entry in the currently loaded tree is to be processed.
  // It can be passed to either JpsiMuMCSelector::GetEntry() or TBranch::GetEntry()
  ...
  TLorentzVector BachMuP;
  BachMuP.SetXYZT(BachMu_TRUEP_X * 1.0e-3,
  ...
  // EL
  Double_t EL = BachMuP.E();
  EL_Histo->Fill(EL);
  
  // COS THETA
  TVector3 v = -1*JpsiP.Vect();
  Double_t Theta = BachMuP.Angle(v);
...
void JpsiMuMCSelector::SlaveTerminate()
{
...
void JpsiMuMCSelector::Terminate()
{
