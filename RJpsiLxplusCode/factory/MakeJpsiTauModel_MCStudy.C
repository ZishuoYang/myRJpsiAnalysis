...
const double RelLumi = 0.25; // Relative luminosity of fit sample to control sample
const double expMu = 5.5e4*RelLumi; // in total sample; multiply by rellumi
const double expRawR = 0.15;
const double expComb = 2.7e4*RelLumi;
...
void MakeJpsiTauModel_MCStudy() {
  ...
  double mcN_sigtau_2012,mcN_sigmu_2012,mcN_b0comb_2012,mcN_bcomb_2012,mcN_bscomb_2012,ddN_misID_2012;
  ...
  */
  ...
  //  chan_2012.SetData("h_sigtau_2012",locTemplates.Data());
