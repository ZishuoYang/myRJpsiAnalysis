...
void HistFactJpsi_control() {
  ...
  TString mchistos[9]={"sigmu","sigtau","Psi2SMu","JpsiD","JpsiDq2","JpsiDK","misID_2016","fakeJpsi","Bd2JpsiX"
                 ...
                 double mcN_sigmu,mcN_sigtau,mcN_Psi2SMu,mcN_JpsiD,mcN_JpsiDq2,mcN_JpsiDK,mcN_misID,mcN_fakeJpsi,mcN_Bd2JpsiX;
 double *mcnorms[9]={&mcN_sigmu,&mcN_sigtau,&mcN_Psi2SMu,&mcN_JpsiD,&mcN_JpsiDq2,&mcN_JpsiDK,&mcN_misID,&mcN_fakeJpsi,&mcN_Bd2JpsiX};
  for(int i =0; i < 9; i++){
  ...
  sigmu.AddNormFactor("Nmu", expMu, 1e-6, 1e3);
  ...
  Psi2SMu.AddNormFactor("NPsi2Mu",1e1,1e-6,5e2);
 ...
 /************************* Bc->Chi_c{1,2}munu *******************************/
  ...
  JpsiDq2.AddNormFactor("NJpsiDq2",1e2,1e-6,1e3);
  chan.AddSample(JpsiDq2);
 ...
 /************************* Bc->JpsiDK *******************************/
  ...
  JpsiDK.AddNormFactor("NJpsiDK",3e2,1e-6,2e3);
  chan.AddSample(JpsiDK);
 ...
 /************************* Bu,d->JpsiX *******************************/
  ...
  Bd2JpsiX.AddNormFactor("NBd2JpsiX",1e2,1e-6,5e2);
    ...
    if (toyMC) 
    {
      ...
      if(slowplots == true)
      {
        ...
        for (int i = 0; i < q2_bins; i++)
        {
          ...
          model_hf->plotOn(mm2q2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]),DrawOption("F"),FillColor(kGreen+3),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*,*Bd2JpsiX*,*JpsiDK*"));
          model_hf->plotOn(Elq2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]), DrawOption("F"),FillColor(kGreen+3),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*,*Bd2JpsiX*,*JpsiDK*"));
          model_hf->plotOn(mm2q2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]),DrawOption("F"),FillColor(kOrange+2),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*,*Bd2JpsiX*"));
          model_hf->plotOn(Elq2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]), DrawOption("F"),FillColor(kOrange+2),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*,*Bd2JpsiX*"));
          model_hf->plotOn(mm2q2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]),DrawOption("F"),FillColor(kGreen+1),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*"));
          model_hf->plotOn(Elq2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]), DrawOption("F"),FillColor(kGreen+1),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*,*JpsiDq2*"));
          model_hf->plotOn(mm2q2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]),DrawOption("F"),FillColor(kOrange+1),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*"));
          model_hf->plotOn(Elq2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]), DrawOption("F"),FillColor(kOrange+1),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*,*fakeJpsi*"));
          model_hf->plotOn(mm2q2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]),DrawOption("F"),FillColor(kGreen),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*"));
          model_hf->plotOn(Elq2_frame[i], Slice(*idx),ProjWData(*idx,*data),ProjectionRange(rangenames[i]), DrawOption("F"),FillColor(kGreen),Components("*sigmu*,*Psi2SMu*,*JpsiD2*,*misID*"));
